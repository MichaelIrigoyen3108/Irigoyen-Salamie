...
import com.backend.Odontologo.dto.entrada.DomicilioEntradaDto;
...
class PacienteServiceTest {
        ...
        @Test
        @Order(1)
        void deberiaRegistrarseUnPacienteDeNombreMichael_yRetornarSuId() {
            //arrange
            PacienteEntradaDto pacienteEntradaDto = new PacienteEntradaDto("Michael", "Irigoyen", 654321,
            ...
            assertEquals("Michael", pacienteSalidaDto.getNombre());
